      ...
      {paymentMethods.map((method) => (
        <div key={method.id} className="border border-gray-300 shadow-sm rounded-lg p-4 transition hover:shadow-md">
          ...
          >
            ...
            />
            <span
              className={`flex items-center justify-center w-5 h-5 border rounded-full transition-all duration-300 ${
            ...
            <span
              className={`${
                selectedMethod === method.id ? "text-blue-500 font-semibold" : "text-gray-800"
              } font-medium`}
            >
              {method.label}
            </span>
