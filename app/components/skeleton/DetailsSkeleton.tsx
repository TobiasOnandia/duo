...
export const ProductDetailSkeleton: React.FC = () => (
    <main className="container mx-auto  px-4  mt-16">
        <div className="flex flex-col xl:flex-row container gap-8">
            {/* Side Images */}
            <section className="relative flex xl:flex-col flex-row container  gap-4 justify-between space-y-4 md:space-y-0">
                {[...Array(4)].map((_, i) => (
                    <div
                        key={i}
                        className="aspect-square  w-full  max-w-[134px]
            ...
            <section className="relative h-full w-full">
                <div className="aspect-square w-[588px] relative overflow-hidden rounded-lg bg-gray-200 animate-pulse" />
            </section>
